                    ...
                    <div className="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                        <div className="mx-auto w-full max-w-[440px]">
                            ...
                            <form className="space-y-5" onSubmit={submitForm}>
                                ...
                                <div className="relative text-white-dark">
                                    <input id="BloodGroup" type="text" placeholder="Blood Group" name="bloodGroup" onChange={handleChange} className="form-input ps-10 placeholder:text-white-dark" />
                                </div>
                                <div className="relative text-white-dark">
                                    <input
                                        id="GuardianName"
                                ...
                                <div className="relative text-white-dark">
                                    <input id="Mobile" type="number" name="mobileNumber" placeholder="Mobile Number" onChange={handleChange} className="form-input ps-10 placeholder:text-white-dark" />
                                    <span className="absolute start-4 top-1/2 -translate-y-1/2">
                                ...
                                {loading ? <button  className="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]"><ReactLoading type={'spin'} color={'white'} height={20} width={20} /></button>  :   <button type='submit'  className="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]">submit</button>}
                            </form>
                        </div>
                    </div>
                </div>
